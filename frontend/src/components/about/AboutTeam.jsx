            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-gray-600 text-lg">
                        Our team comprises passionate digital strategists, brilliant developers, and creative marketers dedicated to elevating your brand's digital presence.
                    </p>
                </div>
                            ...
                            <div className="relative h-72 overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-[#0b1f2d]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-6">
                                    <div className="flex gap-4">
                                        <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-blue-600 hover:bg-blue-600 hover:text-white transition-colors duration-300">
                                            <FaLinkedinIn />
                                        </a>
                                        <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-blue-400 hover:bg-blue-400 hover:text-white transition-colors duration-300">
                                            <FaTwitter />
                                        </a>
                                        <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-red-500 hover:bg-red-500 hover:text-white transition-colors duration-300">
                                            <FaEnvelope />
                                        </a>
                                    </div>
                                </div>
