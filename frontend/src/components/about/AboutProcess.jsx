    ...
    <section className="bg-[#F9FAFB] py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] text-center mb-4">
          Our Proven <span className="text-blue-600">Growth Blueprint</span>
        </h2>
        <p className="text-center text-[#64748B] max-w-2xl mx-auto mb-16 text-lg">
          We follow a data-driven, systematic approach to ensure every project we touch turns into a digital success story.
        </p>
          ...
          {[
            {
              ...
              desc: "In-depth research and strategic roadmapping."
            },
            {
              title: "Design & Development",
              desc: "Building aesthetics matched with robust technical architecture."
            },
            {
              title: "Marketing Execution",
              desc: "Deploying multi-channel campaigns for max reach."
            },
            {
              title: "Analyze & Scale",
              desc: "Data measurement and continuous ROI optimization."
            },
          ].map((step, index) => (
